...
import {
  ...
  STAGE,
  STAGE_HEIGHT,
} from '@/components/originkit/ui/hero-37/stage';
...
export const SectionHero = () => (
  // Nested in the app's own <main>/<Navbar> (layout.tsx), so this renders a <div>
  // rather than another <main>, and skips the section's own placeholder navbar.
  <div
